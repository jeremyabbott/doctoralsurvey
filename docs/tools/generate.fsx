...
let website = "/DoctoralSurvey"

let githubLink = "http://github.com/jeremyabbott/doctoralsurvey"

// Specify more information about your project
let info =
  [ "project-name", "DoctoralSurvey"
    "project-author", "Jeremy M. Abbott"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/DoctoralSurvey" ]
